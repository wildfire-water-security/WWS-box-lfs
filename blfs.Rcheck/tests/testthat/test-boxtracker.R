test_that("reading boxtracker gives data", {
  ...
  #check values
  expect_equal(read.boxtracker("large-file1", dir=dir, return="file_path"), "subfolder/large-file1.txt")
...
test_that("boxtracker data is grabbed",{
  ...
  dir <- file.path(test_path(), "testdata")
  expect_no_failure(write.boxtracker("subfolder/large-file1.txt", dir=dir))
