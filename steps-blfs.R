...
#start tracking files with Box LFS, push to repo  
...
#once we've made changes, we want to push and see if we need to upload any files to box 
...
#now we can push our file changes (the boxtracker will till others there's a new file to get)
